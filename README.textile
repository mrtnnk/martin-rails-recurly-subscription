...
If you have suggestions for additional features, please create an "issue":http://github.com/mrtnnk/martin-rails-recurly-subscription/issues on GitHub.
...
Problems? Check the "issues":https://github.com/mrtnnk/martin-rails-recurly-subscription/issues.
...
Please create a "GitHub issue":http://github.com/mrtnnk/martin-rails-recurly-subscription/issues if you identify any problems or have suggestions for improvements.
...
Send the author a message, create an "issue":http://github.com/mrtnnk/martin-rails-recurly-subscription/issues, or fork the project and submit a pull request.
